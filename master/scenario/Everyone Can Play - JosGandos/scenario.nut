   ...
   */
map.file = "josgandoskotoskotossampebledos.sve"										// Map FileName ( EDIT )
scenario.short_description = "Everyone Can Play Simutrans - josgandoskotoskotossampebledos"		// Scenario Names ( EDIT )
...
function get_info_text(pl)							// INFOS Text \ Something
{
	...
	+ "<br>Map By : " + "Riyantama Wira"		// Map By :  ( EDIT )
