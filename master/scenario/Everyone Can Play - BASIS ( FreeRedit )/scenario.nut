   ...
   */
map.file = ""										// Map FileName ( EDIT )
scenario.short_description = ""		// Scenario Names ( EDIT )
scenario.author = "Rengga Prakoso - vzrenggamani & "				// Your Name HERE ( EDIT )
scenario.version = ""										// Scenario Version ( EDIT )
scenario.translation = ""			// Your Scenario Translator ( EDIT )
