   ...
   */
map.file = "PT.KAI.sve"										// Map FileName ( EDIT )
scenario.short_description = "Everyone Can Play Simutrans - PT.KAI"		// Scenario Names ( EDIT )
scenario.author = "Rengga Prakoso - vzrenggamani"				// Your Name HERE ( EDIT )
scenario.version = "0.2"										// Scenario Version ( EDIT )
scenario.translation = "None"			// Your Scenario Translator ( EDIT )
...
function get_info_text(pl)							// INFOS Text \ Something
{
	...
	+ "<br>Map By : " + "Unknow ( Suneo mungkin )"		// Map By :  ( EDIT )
